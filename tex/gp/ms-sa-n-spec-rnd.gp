...
set output "tex/gp/ms-sa-n-spec-rnd.tex"
...
set label "$P^\\m{(N)}$" at 2500,0.525 right front

plot 'pro-files/data/gen/ms-sa-n-spec-rnd.csv' using 1:7 with impulses lt 1 lw 3 lc rgb "#AAAAAA",\
