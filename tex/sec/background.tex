...
\label{sec:background}
	...
	\label{ssec:soil-parameters}
		...
		In this report, we concentrate on three important soil parameters that are given by existing NIRS-measurements. %\cite{agelet:10a} alternatively cite the data set
	...
	\label{ssec:nirs}
		...
		NIRS uses electromagnetic waves, %\cite[247-8]{agelet:10a}
