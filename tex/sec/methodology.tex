...
%		\]
	...
	\label{ssec:simulation}
		...
		To address this, we repeat this process $r$ times.
		...
		To gauge influences of the resolution on the model selection, we repeat the simulations described above as follows:
		\[
