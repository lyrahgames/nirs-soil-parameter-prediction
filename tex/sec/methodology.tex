...
\label{sec:methodology}
	...
	\label{ssec:mallows-C_p}
		...
		As it decreases in the number of included parameters, we assume it to be close enough to zero and neglect it from our further considerations \cite{schumacher:16b}.
