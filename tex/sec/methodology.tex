...
%		\end{alignat*}
	...
	\label{ssec:simulation}
		...
		To assess how much the resolution of the NIRS influences the model selection, we repeat the model selection on the simulations, but allow only models from
		\[
			\Lambda^{m} \define \set{\lambda_{mi} \vline \lambda_{mi} \in \Lambda, i \in \SN} \qquad m \in \set{2, 3, 4}
		\]
